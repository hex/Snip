---
name: snip-name-means-snippets
description: '"Snip" is short for "Snippets"; never use scissors or cutting metaphors in its icons, naming, or copy.'
metadata:
  type: project
  node_type: memory
...
**Why:** the obvious-but-wrong reflex is a scissors icon (`scissors` SF Symbol, ✂ emoji). That
...
**How to apply:** use insertion and text imagery. The menu-bar icon is the `text.insert` SF Symbol.
